...
cucumber_1.Given('I am on Sign-in with Gmail page and click on it', { timeout: 100 * 1000 }, function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.browser.wait(protractor_1.ExpectedConditions.visibilityOf(login.signInLabel), 10000);
